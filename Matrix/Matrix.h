...
public:
    ...
    /*Matrix transpose() const; // takes the transpose of the matrix and returns a temp Matrix object
...
private:
    ...
    int rowN, colN;
    float *data;
    // e.g: if data points an array of [ 1, 2, 3, 4, 5, 6] and the rowN=2 and coln=3
    // matrix is actually 
    // 1 2 3
    // 4 5 6
};
